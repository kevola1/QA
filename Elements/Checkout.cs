...
namespace QA_Assessment.Elements
{
    internal class Checkout
    {
        ...
        public IWebElement OrderSummary => WebDriver.FindElement(By.Id("checkout_summary_container"));

        public IWebElement CompleteOrder => WebDriver.FindElement(By.Id("finish"));

        public IWebElement PurchaseSuccessful => WebDriver.FindElement(By.Id("complete-header"));
